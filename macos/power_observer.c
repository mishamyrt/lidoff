...
static void powerCallback(void *ref_con, io_service_t service, natural_t message_type,
...
uint8_t PowerObserverRunLoop(PowerObserverCallback will_sleep, PowerObserverCallback did_wake,
  ...
  CFRunLoopAddSource(CFRunLoopGetCurrent(), IONotificationPortGetRunLoopSource(power_notify_port),
