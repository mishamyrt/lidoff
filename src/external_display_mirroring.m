...
static id objc_msgSend_id(id obj, SEL sel) { return ((id (*)(id, SEL))objc_msgSend)(obj, sel); }
...
static void objc_msgSend_void(id obj, SEL sel) { ((void (*)(id, SEL))objc_msgSend)(obj, sel); }
...
void ExternalDisplayMirroringClearBackups(void) { clearMirrorBackups(); }
...
BOOL ExternalDisplayMirroringHasBackups(void) { return mirrorBackupCount > 0; }
...
static NSDictionary *copyMirroringState(void) {
  ...
  for (size_t i = 0; i < mirrorBackupCount; i++) {
    ...
    [backups addObject:@{@"displayID" : @(backup->displayID), @"mirrorSetIDs" : mirrorSetIDs}];
  }
