...
BOOL ExternalDisplaySkylightHasBackups(void) { return skylightBackupCount > 0; }
...
static void loadSkyLight(void) {
  ...
  SLSConfigureDisplayEnabledPtr =
      (SLSConfigureDisplayEnabledFunc)dlsym(skylightHandle, "SLSConfigureDisplayEnabled");
