...
static void powerCallback(void *refCon, io_service_t service, natural_t messageType,
...
static void registerPowerNotifications(void) {
  powerRootPort = IORegisterForSystemPower(NULL, &powerNotifyPort, powerCallback, &powerNotifier);
  ...
  CFRunLoopAddSource(CFRunLoopGetCurrent(), IONotificationPortGetRunLoopSource(powerNotifyPort),
